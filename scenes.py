...
def cornell():
  class StaticArgs:
    ...
    scene = [
        ...
        Sphere(vec3(.42, .35, 0.8), 1.1, rgb(0.1, .1, .02), 0.98, semi=vec3(-1, -0.7,0.45), semi_low = .45),
        Sphere(vec3(.3, -0.35, 0.9), .4, rgb(0.0, 0.0, 0), rgb(1, 1, 0.8), semi=vec3(1, 1.5,-0.45), semi_low = .7),
...
def ring():
  class StaticArgs:
    ...
    scene = [
        ...
        Sphere(vec3(0, 0, 0.2), .6, rgb(0.1, 0.05, 0), rgb(1, 0.9, 0.4), semi=vec3(0.05, 1,-0.2), semi_low = -.3, semi_high = 0.3),
...
def doubleRing():
  class StaticArgs:
    ...
    scene = [
        ...
        Sphere(vec3(0, 0, 0.2), .5, rgb(0.1, 0.05, 0), rgb(1, 0.8, 0.4), semi=vec3(0.0, 1, 0), semi_low = -1, semi_high = 0.1),
        Sphere(vec3(0, 0.1, 0.2), .5, rgb(0.1, 0.05, 0), rgb(1, 0.8, 0.4), semi=vec3(0.0, 1,0), semi_low = -.1, semi_high = 0.1),
